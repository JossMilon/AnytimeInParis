    ...
    return (
        <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}>
            ...
            <Typography variant="h6" noWrap component="div" align="center" sx={{ width: "100%" }}>
                {weekDaySelected.length > 0? `Je cherche une activité entre ${startTime}h et ${endTime}h le ${formatWeekDays()}` : `Choisis une plage horaire, des jours et découvre ce que tu peux faire sur Paname à ce moment là !!`}
            </Typography>
            </Toolbar>
        </AppBar>
    )
